...
class ListAduanProsesAdminView extends GetView<ListAduanProsesAdminController> {
  const ListAduanProsesAdminView({Key? key}) : super(key: key);
  @override
                            ...
                            children: <Widget>[
                              ...
                              Wrap(
                                children: [
                                  ...
                                  Text(
                                    "${(listAllAduan[index].data() as Map<String, dynamic>)["deadline"] as String}",
                                    style: TextStyle(
                                        fontSize: 15,
                                        fontWeight: FontWeight.bold),
                                  )
                                  ...
                                  children: [
                                    TextButton(
                                      onPressed: () => Get.toNamed(
                                          Routes.DETAIL_ADUAN_PROSES_ADMIN,
